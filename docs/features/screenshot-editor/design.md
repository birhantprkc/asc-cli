# Screenshot Editor: design notes

Contributor notes for the browser editor in `homepage/editor/` and the import command. For using the feature, see [README](README.md).
