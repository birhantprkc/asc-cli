...
The Command Center is the browser UI in `apps/asc-web/command-center`, served by `asc web-server` from the same Hummingbird backend that exposes the REST API.
